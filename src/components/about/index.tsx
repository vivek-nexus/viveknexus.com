        ...
        <section id="about" className="max-w-[1024px] mx-auto px-6 font-extralight py-12 md:py-24 md:pt-12 md:pb-24">
            ...
            <div className="hidden md:block text-lg lg:text-xl">
                <div className="grid grid-cols-3 gap-6 mb-6">
                    <div className="col-span-3 md:col-span-2 h-64 rounded-2xl border border-white3 hover:shadow-whiteGlow2 duration-200 ease-in p-8 flex items-center bg-gradient-to-b from-primaryGreen/20 to-primaryBlue/20">
                        <AboutText number={1} />
                    </div>
                    <div
                ...
                <div className="grid grid-cols-3 gap-6 mb-6">
                    <div className="col-span-3 md:col-span-1 h-64 rounded-2xl border border-white3 hover:shadow-whiteGlow2 duration-200 ease-in p-8 flex items-center bg-gradient-to-b from-primaryGreen/20 to-primaryBlue/20">
                        <AboutText number={2} />
                    </div>
                    <div className="col-span-3 md:col-span-1 h-64 rounded-2xl border border-white3 hover:shadow-whiteGlow2 duration-200 ease-in bg-gradient-to-b from-primaryGreen/50 to-primaryBlue/50 flex justify-center items-center">
