...
export function About() {
    return (
        <section id="about" className="max-w-[1024px] mx-auto px-4 font-extralight">
            ...
            <div className="hidden md:block text-lg lg:text-xl">
                <div className="grid grid-cols-3 gap-6 mb-6">
                    <div className="col-span-3 md:col-span-2 h-64 rounded-2xl border border-white/25 hover:shadow-whiteGlow1 duration-200 ease-in p-8 flex items-center bg-gradient-to-b from-[#007A56]/25 to-[#073174]/25">
                        <AboutText number={1} />
                    </div>
                    <div
