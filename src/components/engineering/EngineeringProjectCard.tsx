...
export function EngineeringProjectCard(
    ...
    return (
        <div className={`relative ${index === 0 ? `col-span-2` : `col-span-2 md:col-span-1`} p-9`}
            style={{
        ...
        >
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <a href={repoLink} target="_blank">
                    <img src="/icons/github.svg" className="h-8 md:h-12 opacity-50" />
                </a>
            </div>
            ...
            <a
                href={hyperLink}
                target="_blank"
                className="w-fit p-4 border border-[#DFDFDF] flex gap-1 items-center"
            >
                {linkText}
